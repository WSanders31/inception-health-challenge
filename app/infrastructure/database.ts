 ...
 */
export class InceptionHealthDatabase extends Stack {
  constructor(app: App, id: string) {
     ...
     */
    new CfnOutput(this, "ExportInceptionHealthDDBArn", {
      exportName: "ExportInceptionHealthDDBArn",
      value: ddb.tableArn,
    });
    new CfnOutput(this, "ExportInceptionHealthDDBName", {
      exportName: "ExportInceptionHealthDDBName",
      value: ddb.tableName,
    });
  }
}
